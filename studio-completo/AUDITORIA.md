...
**Placar: 61 ✅ · 0 ⚠ · 0 ❌** (de 61 exigências)
...
| Auto-bind: objetos do mundo entram no RRW sozinhos | ✅ | 14 | `studio-completo/LEIA-ME.md:327` |
...
| Espaço/órbitas celestes (Képler real) | ✅ | 178 | `studio-completo/LEIA-ME.md:247` |
...
| Fabricação de peças pros sistemas (FABX catálogo) | ✅ | 44 | `studio-completo/LEIA-ME.md:328` |
| Modelagem: primitives/CSG-style/mesh (MESHX-like; no engine: modeler cmds) | ✅ | 35 | `studio-completo/LEIA-ME.md:349` |
...
| PROPS EXAUSTIVAS (todas as curadas por IsA-chain) + aplicação funcional | ✅ | 22 | `studio-completo/LEIA-ME.md:172` |
...
| Undo/Redo com histórico (50, server-side) | ✅ | 25 | `studio-completo/scripts/server.lua:10` |
| Seleção real server-side (Select + SelectedGet) | ✅ | 15 | `studio-completo/AUDITORIA.md:53` |
| Spawn de part com FORMAS reais (Shape/classe) | ✅ | 13 | `studio-completo/LEIA-ME.md:151` |
| Toolbox REAL do Roblox (Creator Store: GetFreeModelsAsync + LoadAsset) | ✅ | 10 | `studio-completo/AUDITORIA.md:55` |
| OUTPUT real (LogService MessageOut/history) + filtros | ✅ | 6 | `studio-completo/LEIA-ME.md:209` |
...
| UI adaptável a dispositivo (escala por largura + wrap de botões) | ✅ | 13 | `studio-completo/LEIA-ME.md:188` |
...
| Colaboração (equipe, convites, co-editores) | ✅ | 8 | `studio-completo/scripts/03_Menus.lua:1117` |
...
| Editor de scripts (abrir Source real, editar, aplicar) | ✅ | 389 | `studio-completo/AUDITORIA.md:68` |
| Painel de testes/build automatizados (pipeline python .rbxl) | ✅ | 11 | `studio-completo/AUDITORIA.md:81` |
| TOPBAR com ABAS estilo Roblox (aba -> página de botões com ícones) | ✅ | 8 | `studio-completo/scripts/05_StudioX.lua:94` |
| Ícones desenhados/atlas de sistemas (neôn procedural + atlas PNG) | ✅ | 8 | `studio-completo/LEIA-ME.md:147` |
| Color picker INLINE nas propriedades (só aparece no clique do quadrado) | ✅ | 5 | `studio-completo/scripts/08_RealityX.lua:2370` |
| Python bridge SEM erro (HttpService via servidor; PyStatus/PyRun) | ✅ | 26 | `studio-completo/LEIA-ME.md:173` |
| Part com submenu de formas NA TOPBAR (estilo Studio) | ✅ | 7 | `studio-completo/scripts/09_Topbar.lua:402` |
| CSG real (Union/Negate = PartOperation + histórico) | ✅ | 11 | `studio-completo/scripts/server.lua:1437` |
...
| Exigência | Status | Ocorrências | Evidência |
|---|---|---|---|
| Placa X passa na validação #StudioSafe (121 chunks PROP, PRNT/END) | ✅ | 6 | `studio-completo/AUDITORIA.md:80` |
| Suíte de testes automatizada com painéis (run_tests) | ✅ | 8 | `studio-completo/LEIA-ME.md:29` |
| Assinatura de autor (AUTHORIZED_USERNAMES) com anti-explorer | ✅ | 19 | `studio-completo/AUDITORIA.md:82` |
| Resposta anti-erro: erro repetido = mensagem única (root-cause) | ✅ | 3 | `studio-completo/LEIA-ME.md:258` |
