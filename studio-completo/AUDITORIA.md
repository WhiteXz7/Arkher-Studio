...
| Submenus reais nos menus + tooltips + headers de seção | ✅ | 7 | `studio-completo/scripts/03_Menus.lua:609` |
...
| Editor de scripts (abrir Source real, editar, aplicar) | ✅ | 270 | `studio-completo/AUDITORIA.md:68` |
...
| CSG real (Union/Negate = PartOperation + histórico) | ✅ | 12 | `studio-completo/scripts/03_Menus.lua:2188` |
...
| Presença no collab (quem está editando o quê) | ✅ | 5 | `studio-completo/scripts/03_Menus.lua:1099` |
...
| Menus da faixa (ESTÚDIO/MODELAGEM/...) clicáveis (overlay morto + duplo sinal) | ✅ | 227 | `studio-completo/LEIA-ME.md:169` |
