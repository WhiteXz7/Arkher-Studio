...
ICON.undo = function(c)
	px(c, 6, 9, 9, 2, T.txt)
	px(c, 2.8, 7.8, 4.4, 4.4, T.txt, 0, 45)
end
ICON.redo = function(c)
	px(c, 5, 9, 9, 2, T.txt)
	px(c, 12.8, 7.8, 4.4, 4.4, T.txt, 0, 45)
end
ICON.anchor = function(c)
	px(c, 8.4, 1.4, 3.2, 3.2, T.accent2)
	px(c, 9.2, 4.4, 1.6, 10, T.txt)
	px(c, 5.5, 6, 9, 1.6, T.txt)
	px(c, 4.2, 11.6, 5, 1.8, T.txt, 0, 35)
	px(c, 10.8, 11.6, 5, 1.8, T.txt, 0, -35)
end
ICON.snap = function(c)
	local red = C("#E05252")
	local white = C("#FFFFFF")
	px(c, 4, 4, 3.4, 9, red)
	px(c, 12.6, 4, 3.4, 9, red)
	px(c, 4, 4, 3.4, 3, white)
	px(c, 12.6, 4, 3.4, 3, white)
	px(c, 4, 10.4, 12, 2.6, T.txt2)
end
ICON.group = function(c)
	px(c, 3, 3, 8, 8, T.accent)
	px(c, 9, 9, 8, 8, T.txt2)
end
ICON.ungroup = function(c)
	px(c, 2.5, 6, 6, 8, T.txt2)
	px(c, 11.5, 6, 6, 8, T.txt2)
	px(c, 8.7, 8.7, 2.6, 2.6, T.accent2, 0, 45)
end
ICON.copy = function(c)
	px(c, 4, 4, 8, 8, T.accent2)
	px(c, 8, 8, 8, 8, T.txt)
end
ICON.cut = function(c)
	px(c, 3, 4, 3, 3, T.txt)
	px(c, 3, 13, 3, 3, T.txt)
	px(c, 6, 8, 12, 1.6, T.txt, nil, 18)
	px(c, 6, 10.4, 12, 1.6, T.txt, nil, -18)
end
ICON.paste = function(c)
	px(c, 5, 4, 10, 13, T.txt2)
	px(c, 8, 2.5, 4, 3, T.accent2)
	px(c, 7, 8, 6, 1.4, T.txt4)
	px(c, 7, 11, 6, 1.4, T.txt4)
end
ICON.expand = function(c)
	px(c, 3, 3, 5, 1.6, T.txt)
	px(c, 3, 3, 1.6, 5, T.txt)
	px(c, 12, 3, 5, 1.6, T.txt)
	px(c, 15.4, 3, 1.6, 5, T.txt)
	px(c, 3, 15.4, 5, 1.6, T.txt)
	px(c, 3, 12, 1.6, 5, T.txt)
	px(c, 12, 15.4, 5, 1.6, T.txt)
	px(c, 15.4, 12, 1.6, 5, T.txt)
end
ICON.bell = function(c)
	px(c, 9.2, 2.4, 1.6, 1.6, T.txt)
	px(c, 6, 4, 8, 9, T.txt)
	px(c, 4.5, 12.5, 11, 2, T.txt)
	px(c, 9, 15, 2, 2, T.accent2)
end
ICON.home = function(c)
	px(c, 6.5, 4.5, 7, 7, T.txt, nil, 45)
	px(c, 5, 10, 10, 7, T.txt2)
	px(c, 9, 13, 2, 4, T.accent2)
end
ICON.drop = function(c)
	px(c, 6.5, 3.5, 7, 7, T.accent2, nil, 45)
	px(c, 6.5, 8.5, 7, 7, T.accent2)
end
ICON.plug = function(c)
	px(c, 7.5, 3.5, 2, 5, T.txt)
	px(c, 10.5, 3.5, 2, 5, T.txt)
	px(c, 6, 9, 8, 8, T.txt2)
	px(c, 9.2, 17, 1.6, 2, T.txt)
end
ICON.note = function(c)
	px(c, 6.5, 12.5, 5, 4.5, T.accent2)
	px(c, 11, 3, 2, 11, T.txt)
	px(c, 10.5, 2.2, 6, 1.8, T.txt, nil, 30)
end
ICON.fire = function(c)
	px(c, 6.5, 7.5, 7, 7, T.orange, nil, 45)
	px(c, 8, 10.5, 4, 4, T.yellow, nil, 45)
	px(c, 6, 14.5, 8, 2.4, T.orange)
end
ICON.character = function(c)
	px(c, 8.5, 3, 3, 3, T.txt)
	px(c, 8, 6.5, 4, 6, T.txt2)
	px(c, 8, 12.5, 1.6, 5, T.txt2)
	px(c, 10.4, 12.5, 1.6, 5, T.txt2)
end
ICON.npc = function(c)
	px(c, 9.2, 1, 1.6, 2.6, T.accent2)
	px(c, 8.5, 5, 3, 3, T.txt)
	px(c, 8, 8.5, 4, 4.5, T.txt2)
	px(c, 8, 13, 1.6, 4, T.txt2)
	px(c, 10.4, 13, 1.6, 4, T.txt2)
end
ICON.ai = function(c)
	px(c, 4, 4, 2, 2, T.txt)
	px(c, 14, 4, 2, 2, T.txt)
	px(c, 4, 14, 2, 2, T.txt)
	px(c, 14, 14, 2, 2, T.txt)
	px(c, 6, 6, 8, 8, T.txt2)
	px(c, 9, 9, 2, 2, T.accent2)
end
ICON.cutscene = function(c)
	px(c, 4, 4.5, 12, 2.6, T.txt, nil, -12)
	px(c, 4, 8.5, 12, 7, T.txt2)
	px(c, 6, 10, 2, 4.5, T.accent2)
end
ICON.effects = function(c)
	px(c, 9.2, 2.5, 1.6, 4.5, T.txt)
	px(c, 9.2, 13, 1.6, 4.5, T.txt)
	px(c, 2.5, 9.2, 4.5, 1.6, T.txt)
	px(c, 13, 9.2, 4.5, 1.6, T.txt)
	px(c, 9, 9, 2, 2, T.accent2)
end
ICON.particles = function(c)
	px(c, 4, 4, 2, 2, T.txt)
	px(c, 9.5, 3, 2, 2, T.accent2)
	px(c, 14.5, 5, 2, 2, T.txt)
	px(c, 4.5, 10, 2, 2, T.accent2)
	px(c, 10, 9, 2, 2, T.txt)
	px(c, 15, 12, 2, 2, T.accent2)
	px(c, 6.5, 15, 2, 2, T.txt)
	px(c, 12, 16, 2, 2, T.accent2)
end
ICON.render = function(c)
	px(c, 4, 5, 12, 8, T.txt2)
	px(c, 9, 7.5, 2.5, 3, T.accent2)
	px(c, 9.2, 13, 1.6, 2.6, T.txt)
	px(c, 6, 15.6, 8, 1.6, T.txt)
end
ICON.environment = function(c)
	px(c, 14, 2.5, 2.2, 2.2, T.yellow)
	px(c, 6, 5.5, 8, 7, T.green)
	px(c, 9.2, 12, 1.6, 5, T.txt)
end
ICON.testing = function(c)
	px(c, 8.5, 3, 3, 3, T.txt)
	px(c, 6, 6, 8, 10, T.txt2)
	px(c, 7, 11, 6, 4, T.accent2)
end
ICON.multiplayer = function(c)
	px(c, 4, 5, 3.4, 3.4, T.txt)
	px(c, 3.5, 9, 4.4, 6, T.txt2)
	px(c, 12.6, 5, 3.4, 3.4, T.txt)
	px(c, 12.1, 9, 4.4, 6, T.txt2)
end
ICON.performance = function(c)
	px(c, 5, 5, 10, 10, T.txt2)
	px(c, 6, 3.2, 1.6, 1.6, T.txt4)
	px(c, 12.4, 3.2, 1.6, 1.6, T.txt4)
	px(c, 9.2, 2.6, 1.6, 1.6, T.accent2)
	px(c, 9, 5.5, 2, 6, T.accent2, nil, 35)
	px(c, 8.6, 9, 2.8, 2.8, T.bg1)
end
ICON.file = function(c)
	px(c, 6, 2.5, 8, 15, T.txt)
	px(c, 12, 2.5, 2, 2, T.accent2)
	px(c, 7.5, 7, 5, 1.2, T.txt4)
	px(c, 7.5, 10, 5, 1.2, T.txt4)
end
ICON.edit = function(c)
	px(c, 3, 6, 14, 1.4, T.txt4)
	px(c, 3, 10, 14, 1.4, T.txt4)
	px(c, 3, 14, 14, 1.4, T.txt4)
	px(c, 5.5, 5, 2.2, 3, T.accent2)
	px(c, 11, 9, 2.2, 3, T.accent2)
	px(c, 8, 13, 2.2, 3, T.accent2)
end
ICON.view = function(c)
	px(c, 2.5, 7, 15, 6, T.txt)
	px(c, 8.5, 8, 3, 4, T.accent2)
end
ICON.insert = function(c)
	px(c, 9, 2.5, 2, 7, T.txt)
	px(c, 6.5, 4.5, 7, 2, T.txt)
	px(c, 4, 12, 12, 5, T.txt2)
end
ICON.run = function(c)
	px(c, 6, 2.5, 1.8, 15, T.txt)
	px(c, 7.8, 2.5, 7, 4.5, T.green)
end
ICON.game = function(c)
	px(c, 3.5, 7, 13, 7, T.txt2)
	px(c, 6, 8.5, 2, 4, T.txt)
	px(c, 5, 9.5, 4, 2, T.txt)
	px(c, 12, 9, 1.8, 1.8, T.accent2)
	px(c, 14, 10.5, 1.8, 1.8, T.accent2)
end
ICON.physics = function(c)
	px(c, 9, 1.5, 2, 2, T.txt)
	px(c, 9.6, 3.5, 0.8, 7, T.txt)
	px(c, 7.5, 10.5, 5, 5, T.accent2)
end
ICON.assets = function(c)
	px(c, 5, 5, 10, 10, T.txt2)
	px(c, 9, 5, 2, 10, T.txt4)
	px(c, 5, 9, 10, 2, T.txt4)
end
ICON.keyframe = function(c)
	px(c, 2, 9.3, 16, 1.4, T.txt4)
	px(c, 8, 7, 4, 4, T.accent2, nil, 45)
end
