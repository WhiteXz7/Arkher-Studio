...
local function find(name)
  ...
  -- depois fallback canvas-wide (i18n do header H_* + abas Tab_* + Lbl do ribbon).
...
local LANG_PATH_PT = {
  ...
  -- topbar unica R20: gerado por tools/gen_topbar_wiring.py
  -- @@TOPBAR_LANG@@
  -- abas (Tab_<T>/Lbl)
  { "Tab_HOME", "Lbl", "Início" },
  { "Tab_TERRAIN", "Lbl", "Terreno" },
  { "Tab_OBJECTS", "Lbl", "Objetos" },
  { "Tab_LANDSCAPE", "Lbl", "Paisagem" },
  { "Tab_SCENES", "Lbl", "Cenas" },
  { "Tab_UI", "Lbl", "Interface" },
  { "Tab_SCRIPTS", "Lbl", "Scripts" },
  { "Tab_PLUGINS", "Lbl", "Plugins" },
  { "Tab_WORLD", "Lbl", "Mundo" },
  { "Tab_MODELS", "Lbl", "Modelos" },
  { "Tab_MATERIALS", "Lbl", "Materiais" },
  { "Tab_LIGHTING", "Lbl", "Iluminação" },
  { "Tab_CLIMATE", "Lbl", "Clima" },
  { "Tab_WATER", "Lbl", "Água" },
  { "Tab_CAMERA", "Lbl", "Câmera" },
  { "Tab_TOOLS", "Lbl", "Ferramentas" },
  { "Tab_SETTINGS", "Lbl", "Configurações" },
  { "Tab_HELP", "Lbl", "Ajuda" },
  -- HOME
  { "RibbonBtn_HOME_New", "Lbl", "Novo" },
  { "RibbonBtn_HOME_Open", "Lbl", "Abrir" },
  { "RibbonBtn_HOME_OpenEmpty", "Lbl", "Abrir\nVazio" },
  { "RibbonBtn_HOME_OpenTerrain", "Lbl", "Terreno" },
  { "RibbonBtn_HOME_Save", "Lbl", "Salvar" },
  { "RibbonBtn_HOME_SaveCloud", "Lbl", "Nuvem" },
  { "RibbonBtn_HOME_Export", "Lbl", "Exportar" },
  { "RibbonBtn_HOME_Import", "Lbl", "Importar" },
  { "RibbonBtn_HOME_Exit", "Lbl", "Sair" },
  { "RibbonBtn_HOME_Undo", "Lbl", "Desfazer" },
  { "RibbonBtn_HOME_Redo", "Lbl", "Refazer" },
  { "RibbonBtn_HOME_Cut", "Lbl", "Cortar" },
  { "RibbonBtn_HOME_Copy", "Lbl", "Copiar" },
  { "RibbonBtn_HOME_Paste", "Lbl", "Colar" },
  { "RibbonBtn_HOME_Duplicate", "Lbl", "Duplicar" },
  { "RibbonBtn_HOME_Rename", "Lbl", "Renomear" },
  { "RibbonBtn_HOME_Delete", "Lbl", "Excluir" },
  { "RibbonBtn_HOME_Play", "Lbl", "Jogar" },
  { "RibbonBtn_HOME_Pause", "Lbl", "Pausar" },
  { "RibbonBtn_HOME_Stop", "Lbl", "Parar" },
  -- TERRAIN
  { "RibbonBtn_TERRAIN_TerrainEditor", "Lbl", "Editor de\nTerreno" },
  { "RibbonBtn_TERRAIN_TerrainX", "Lbl", "Terreno X" },
  { "RibbonBtn_TERRAIN_TerrainGen", "Lbl", "Gerador" },
  { "RibbonBtn_TERRAIN_VoxelProbe", "Lbl", "Sonda\nVoxel" },
  { "RibbonBtn_TERRAIN_TerrainProbe", "Lbl", "Sonda" },
  { "RibbonBtn_TERRAIN_Generate", "Lbl", "Gerar" },
  { "RibbonBtn_TERRAIN_Erode", "Lbl", "Erosão" },
  { "RibbonBtn_TERRAIN_Crater", "Lbl", "Cratera" },
  { "RibbonBtn_TERRAIN_Flatten", "Lbl", "Aplainar" },
  { "RibbonBtn_TERRAIN_Smooth", "Lbl", "Suavizar" },
  { "RibbonBtn_TERRAIN_Noise", "Lbl", "Ruído" },
  -- OBJECTS
  { "RibbonBtn_OBJECTS_Part", "Lbl", "Peça" },
  { "RibbonBtn_OBJECTS_Folder", "Lbl", "Pasta" },
  { "RibbonBtn_OBJECTS_Model", "Lbl", "Modelo" },
  { "RibbonBtn_OBJECTS_Script", "Lbl", "Script" },
  { "RibbonBtn_OBJECTS_Text", "Lbl", "Texto" },
  { "RibbonBtn_OBJECTS_InsertFull", "Lbl", "Inserir\nTudo" },
  { "RibbonBtn_OBJECTS_Group", "Lbl", "Agrupar" },
  { "RibbonBtn_OBJECTS_Ungroup", "Lbl", "Desagrupar" },
  { "RibbonBtn_OBJECTS_PivotReset", "Lbl", "Zerar\nPivô" },
  { "RibbonBtn_OBJECTS_AlignX", "Lbl", "Alinhar X" },
  { "RibbonBtn_OBJECTS_AlignY", "Lbl", "Alinhar Y" },
  { "RibbonBtn_OBJECTS_AlignZ", "Lbl", "Alinhar Z" },
  { "RibbonBtn_OBJECTS_DistX", "Lbl", "Distrib X" },
  { "RibbonBtn_OBJECTS_DistY", "Lbl", "Distrib Y" },
  { "RibbonBtn_OBJECTS_DistZ", "Lbl", "Distrib Z" },
  { "RibbonBtn_OBJECTS_MirrX", "Lbl", "Espelho X" },
  { "RibbonBtn_OBJECTS_MirrY", "Lbl", "Espelho Y" },
  { "RibbonBtn_OBJECTS_MirrZ", "Lbl", "Espelho Z" },
  { "RibbonBtn_OBJECTS_Lock", "Lbl", "Travar" },
  { "RibbonBtn_OBJECTS_LocalGlobal", "Lbl", "Local\nGlobal" },
  -- LANDSCAPE
  { "RibbonBtn_LANDSCAPE_Life", "Lbl", "Vida" },
  { "RibbonBtn_LANDSCAPE_EcoSim", "Lbl", "Eco Sim" },
  { "RibbonBtn_LANDSCAPE_Human", "Lbl", "Humano" },
  { "RibbonBtn_LANDSCAPE_NPC", "Lbl", "NPC" },
  { "RibbonBtn_LANDSCAPE_City", "Lbl", "Cidade" },
  { "RibbonBtn_LANDSCAPE_Village", "Lbl", "Vila" },
  { "RibbonBtn_LANDSCAPE_Metro", "Lbl", "Metrô" },
  -- SCENES
  { "RibbonBtn_SCENES_Places", "Lbl", "Lugares" },
  { "RibbonBtn_SCENES_PlacesProfile", "Lbl", "Meus\nLugares" },
  { "RibbonBtn_SCENES_HomeEditor", "Lbl", "Início" },
  { "RibbonBtn_SCENES_SaveToArkher", "Lbl", "Salvar na\nArkher" },
  { "RibbonBtn_SCENES_Publish", "Lbl", "Publicar" },
  { "RibbonBtn_SCENES_PublishBridge", "Lbl", "Ponte" },
  { "RibbonBtn_SCENES_ResetWorkspace", "Lbl", "Zerar\nMundo" },
  { "RibbonBtn_SCENES_RecKeyA", "Lbl", "Gravar A" },
  { "RibbonBtn_SCENES_RecKeyB", "Lbl", "Gravar B" },
  { "RibbonBtn_SCENES_PlayA", "Lbl", "Tocar A" },
  { "RibbonBtn_SCENES_PlayB", "Lbl", "Tocar B" },
  { "RibbonBtn_SCENES_AnimStop", "Lbl", "Parar" },
  -- UI
  { "RibbonBtn_UI_UIEditor", "Lbl", "Editor de\nUI" },
  { "RibbonBtn_UI_Colors", "Lbl", "Cores" },
  { "RibbonBtn_UI_PropsPlus", "Lbl", "Props+" },
  { "RibbonBtn_UI_Output", "Lbl", "Saída" },
  { "RibbonBtn_UI_ClearOutput", "Lbl", "Limpar\nSaída" },
  { "RibbonBtn_UI_Hierarchy", "Lbl", "Hierarquia" },
  { "RibbonBtn_UI_Properties", "Lbl", "Props" },
  -- SCRIPTS
  { "RibbonBtn_SCRIPTS_ScriptStudio", "Lbl", "Script\nStudio" },
  { "RibbonBtn_SCRIPTS_AllScripts", "Lbl", "Todos\nScripts" },
  { "RibbonBtn_SCRIPTS_Python", "Lbl", "Python" },
  { "RibbonBtn_SCRIPTS_CommandBar", "Lbl", "Barra de\nComando" },
  { "RibbonBtn_SCRIPTS_ScriptEditor", "Lbl", "Editor de\nScript" },
  -- PLUGINS
  { "RibbonBtn_PLUGINS_Plugins", "Lbl", "Plugins" },
  { "RibbonBtn_PLUGINS_CloudInfo", "Lbl", "Nuvem\nInfo" },
  { "RibbonBtn_PLUGINS_Toolbox", "Lbl", "Toolbox" },
  { "RibbonBtn_PLUGINS_CreatorStore", "Lbl", "Loja" },
  { "RibbonBtn_PLUGINS_CollabSettings", "Lbl", "Colab" },
  { "RibbonBtn_PLUGINS_Collaborate", "Lbl", "Colaborar" },
  { "RibbonBtn_PLUGINS_Invites", "Lbl", "Convites" },
  { "RibbonBtn_PLUGINS_Changes", "Lbl", "Mudanças" },
  { "RibbonBtn_PLUGINS_Account", "Lbl", "Conta" },
  -- WORLD
  { "RibbonBtn_WORLD_WorldEditor", "Lbl", "Mundo" },
  { "RibbonBtn_WORLD_Space", "Lbl", "Espaço" },
  { "RibbonBtn_WORLD_SolarSystem", "Lbl", "Sistema\nSolar" },
  { "RibbonBtn_WORLD_EarthMoon", "Lbl", "Terra-\nLua" },
  { "RibbonBtn_WORLD_GameProps", "Lbl", "Props do\nJogo" },
  -- MODELS
  { "RibbonBtn_MODELS_ModelerPRO", "Lbl", "Modeler\nPRO" },
  { "RibbonBtn_MODELS_Block", "Lbl", "Bloco" },
  { "RibbonBtn_MODELS_Wedge", "Lbl", "Cunha" },
  { "RibbonBtn_MODELS_Cylinder", "Lbl", "Cilindro" },
  { "RibbonBtn_MODELS_Ball", "Lbl", "Esfera" },
  { "RibbonBtn_MODELS_Corner", "Lbl", "Canto" },
  { "RibbonBtn_MODELS_Truss", "Lbl", "Treliça" },
  { "RibbonBtn_MODELS_MeshPart", "Lbl", "Malha" },
  { "RibbonBtn_MODELS_Join", "Lbl", "Unir" },
  { "RibbonBtn_MODELS_Split", "Lbl", "Separar" },
  { "RibbonBtn_MODELS_Modeler", "Lbl", "Modelador" },
  { "RibbonBtn_MODELS_ModelerPrims", "Lbl", "Primitivos" },
  { "RibbonBtn_MODELS_RopeDemo", "Lbl", "Demo\nCorda" },
  { "RibbonBtn_MODELS_RopeBridge", "Lbl", "Ponte de\nCorda" },
  { "RibbonBtn_MODELS_Ropes", "Lbl", "Cordas" },
  -- MATERIALS
  { "RibbonBtn_MATERIALS_Color", "Lbl", "Cor" },
  { "RibbonBtn_MATERIALS_Material", "Lbl", "Material" },
  { "RibbonBtn_MATERIALS_Surface", "Lbl", "Superfície" },
  { "RibbonBtn_MATERIALS_Decal", "Lbl", "Decalque" },
  { "RibbonBtn_MATERIALS_Texture", "Lbl", "Textura" },
  -- LIGHTING
  { "RibbonBtn_LIGHTING_RRW", "Lbl", "RRW" },
  { "RibbonBtn_LIGHTING_Sky", "Lbl", "Céu" },
  { "RibbonBtn_LIGHTING_TimeOfDay", "Lbl", "Hora" },
  { "RibbonBtn_LIGHTING_FXPanel", "Lbl", "FX" },
  { "RibbonBtn_LIGHTING_Fire", "Lbl", "Fogo" },
  { "RibbonBtn_LIGHTING_Atmosphere", "Lbl", "Atmosfera" },
  { "RibbonBtn_LIGHTING_Light", "Lbl", "Luz" },
  { "RibbonBtn_LIGHTING_Particles", "Lbl", "Partículas" },
  -- CLIMATE
  { "RibbonBtn_CLIMATE_Climate", "Lbl", "Clima" },
  { "RibbonBtn_CLIMATE_ClimateOn", "Lbl", "Clima\nOn" },
  { "RibbonBtn_CLIMATE_ClimateOff", "Lbl", "Clima\nOff" },
  { "RibbonBtn_CLIMATE_Rain", "Lbl", "Chuva" },
  -- WATER
  { "RibbonBtn_WATER_Ocean", "Lbl", "Oceano" },
  { "RibbonBtn_WATER_Buoyancy", "Lbl", "Flutuar" },
  { "RibbonBtn_WATER_WaterTools", "Lbl", "Ferram.\nÁgua" },
  -- CAMERA
  { "RibbonBtn_CAMERA_Camera", "Lbl", "Câmera" },
  { "RibbonBtn_CAMERA_Viewport", "Lbl", "Viewport" },
  { "RibbonBtn_CAMERA_Fullscreen", "Lbl", "Tela\ncheia" },
  { "RibbonBtn_CAMERA_ResetLayout", "Lbl", "Zerar\nLayout" },
  -- TOOLS
  { "RibbonBtn_TOOLS_Fabricate", "Lbl", "Fabricar" },
  { "RibbonBtn_TOOLS_FabList", "Lbl", "Lista\nFab" },
  { "RibbonBtn_TOOLS_Snap", "Lbl", "Encaixe" },
  { "RibbonBtn_TOOLS_Transform", "Lbl", "Transformar" },
  { "RibbonBtn_TOOLS_Sound", "Lbl", "Som" },
  { "RibbonBtn_TOOLS_DO15", "Lbl", "D-O15" },
  { "RibbonBtn_TOOLS_AnimatorPRO", "Lbl", "Animator\nPRO" },
  { "RibbonBtn_TOOLS_Animator", "Lbl", "Animador" },
  { "RibbonBtn_TOOLS_RigEditor", "Lbl", "Rig" },
  { "RibbonBtn_TOOLS_PhysAnim", "Lbl", "Anim\nFísica" },
  { "RibbonBtn_TOOLS_AudioTools", "Lbl", "Áudio" },
  { "RibbonBtn_TOOLS_AudioInt", "Lbl", "Áudio\nInter" },
  { "RibbonBtn_TOOLS_Mixer", "Lbl", "Mixer" },
  { "RibbonBtn_TOOLS_Anchor", "Lbl", "Ancorar" },
  { "RibbonBtn_TOOLS_Collision", "Lbl", "Colisão" },
  { "RibbonBtn_TOOLS_Select", "Lbl", "Selecionar" },
  { "RibbonBtn_TOOLS_Move", "Lbl", "Mover" },
  { "RibbonBtn_TOOLS_Rotate", "Lbl", "Girar" },
  { "RibbonBtn_TOOLS_Scale", "Lbl", "Escala" },
  -- SETTINGS
  { "RibbonBtn_SETTINGS_GameSettings", "Lbl", "Config\nJogo" },
  { "RibbonBtn_SETTINGS_Data", "Lbl", "Dados" },
  { "RibbonBtn_SETTINGS_Language", "Lbl", "Idioma" },
  { "RibbonBtn_SETTINGS_Settings", "Lbl", "Ajustes" },
  { "RibbonBtn_SETTINGS_LangPT", "Lbl", "PT-BR" },
  { "RibbonBtn_SETTINGS_ProjSettings", "Lbl", "Config\nProjeto" },
  -- HELP
  { "RibbonBtn_HELP_StudioHelp", "Lbl", "Ajuda do\nStudio" },
  { "RibbonBtn_HELP_CommandHelp", "Lbl", "Ajuda\nComando" },
  -- @@/TOPBAR_LANG@@
