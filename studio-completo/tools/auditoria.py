...
CHECKS = [
    ...
    ("IDE", "TOPBAR com ABAS estilo Roblox (aba -> página de botões com ícones)",
     ["ArkherTabStrip", "Arkher_09_Topbar", "drawIcon"], None),
    ("IDE", "Ícones desenhados/atlas de sistemas (neôn procedural + atlas PNG)",
     ["Icon_TERRAIN", "atlas_sistemas", "IconX"], None),
