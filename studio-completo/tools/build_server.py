...
src = replace_once(src, "request.OnServerInvoke=function(player,action,payload)", NEW_HANDLERS + BLOCK_S + BLOCK_X7 + BLOCK_X8 + BLOCK_X9 + BLOCK_X10 + BLOCK_X11 + BLOCK_X12 + "request.OnServerInvoke=function(player,action,payload)", "D")
