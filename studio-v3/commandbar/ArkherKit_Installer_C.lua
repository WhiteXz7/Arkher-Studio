--[[ ARKHER V3 — Installer ArkherKit_C: cria o ModuleScript em ReplicatedStorage.ArkherV3 ]]
local KIT = [====[
...
local mod = holder:FindFirstChild("ArkherKit_C")
if not mod then
	mod = Instance.new("ModuleScript")
	mod.Name = "ArkherKit_C"
	mod.Parent = holder
end
mod.Source = KIT
print("[ARKHER V3] ArkherKit_C instalado em ReplicatedStorage.ArkherV3")
