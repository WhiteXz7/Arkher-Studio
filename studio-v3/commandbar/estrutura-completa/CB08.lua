--[[ =====================================================================
  ARKHER V3 — ESTRUTURA COMPLETA (8/13)
  Server — ArkherKit_Installer_A
  Cria: ServerScriptService.Arkher.ArkherKit_Installer_A (Script desativado)
...
local S_INST = [=====[--[[ ARKHER V3 — Installer ArkherKit_A: cria o ModuleScript em ReplicatedStorage.ArkherV3 ]]
...
local t = arkher:FindFirstChild("ArkherKit_Installer_A")
if not t then t = Instance.new("Script") t.Name = "ArkherKit_Installer_A" t.Parent = arkher end
t.Source = S_INST
	t.Disabled = true
print("[ARKHER V3] (8/13) ArkherKit_Installer_A guardado em ServerScriptService.Arkher (desativado)")
