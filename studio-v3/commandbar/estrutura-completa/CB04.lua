--[[ =====================================================================
  ARKHER V3 — ESTRUTURA COMPLETA (4/13)
  Launcher 2/2 — ArkherBundle_Scene
  Cria: StarterPlayerScripts.Arkher.ArkherBundle_Scene (LocalScript ativo)
...
local t = arkher:FindFirstChild("ArkherBundle_Scene")
if not t then t = Instance.new("LocalScript") t.Name = "ArkherBundle_Scene" t.Parent = arkher end
t.Source = S_SC
print("[ARKHER V3] (4/13) ArkherBundle_Scene instalado em StarterPlayerScripts.Arkher")
