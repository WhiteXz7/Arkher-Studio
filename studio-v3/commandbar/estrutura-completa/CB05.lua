--[[ =====================================================================
  ARKHER V3 — ESTRUTURA COMPLETA (5/13)
  Launcher 3/2 — ArkherBundle_System
  Cria: StarterPlayerScripts.Arkher.ArkherBundle_System (LocalScript ativo)
...
local S_SC = [====[--[[ ARKHER V3 — LocalScript. Requer o kit (ReplicatedStorage.ArkherV3.ArkherKit_B). ]]
...
local t = arkher:FindFirstChild("ArkherBundle_System")
if not t then t = Instance.new("LocalScript") t.Name = "ArkherBundle_System" t.Parent = arkher end
t.Source = S_SC
print("[ARKHER V3] (5/13) ArkherBundle_System instalado em StarterPlayerScripts.Arkher")
